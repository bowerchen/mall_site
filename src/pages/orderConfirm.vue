                ...
                <div class="order-box">
                    ...
                    <div class="detail">
                        ...
                        <div class="item">
                            ...
                            <span class="item-val">{{cartTotalPrice}}件</span>
                        </div>
                        <div class="item">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="javascrip:;" class="btn btn-large" @click="orderSubmit">去结算</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        >
            <template>
                <div class="edit-wrap">
                    ...
                    <div class="item">
                        <select name="province" v-model="checkItem.receiverProvice">
